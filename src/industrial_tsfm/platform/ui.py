...
document.getElementById('analyticsBody').className='';document.getElementById('analyticsBody').innerHTML='<div>'+c.analytics.map(x=>'<span class="pill">'+esc(x)+'</span>').join('')+'</div>';
